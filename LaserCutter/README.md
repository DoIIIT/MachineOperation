...
The power button on the top right corner should be **RED**. If it is grey, please reconnect the USB cable, close the program, and open it again.
...
If the calibration sound from the laser cutter stop, but the UCP program is still not in Idle mode. Close the program and reopen it again.
...
**!!!IMPORTANT!!!:  
Always do a test cutting before procedding any major task. The default setting might not suit your needs. A test cutting can prevent from causing serious danger and wasting material.**  
...
Chose the units you are using. It should be inches if you are using the template we provide.  
![Units](img/units.png)

Other setting should remain unchange.  
...
Put your material on the cutting table. Make sure it is level and flat. Unevan material might damage the laser cutter.  
...
Click one of the nine anchor point, and click To Pointer to move the anchor point to the blue anchor point we set previously in focus view.
...
Before running any laser cutter job, you will need to open the **fume extractor**. The fume extractor is located right underness the laser cutter.

The power of the fume extractor is located on the **right hand side**. Open the power and you should hear a very loud noise.

Once the fume extractor is running, double check all of your setting, and you should ready to go.

Close the door. And you can hit the Green button to Start running your laser-cutting job.


### 7. Clean Up and Turn off the Machine.
